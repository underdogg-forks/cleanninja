...
CREATE TABLE `accounts` (
  ...
  `allow_approve_expired_quote` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  ...
  KEY `accounts_plan_id_foreign` (`plan_id`),
  CONSTRAINT `accounts_plan_id_foreign` FOREIGN KEY (`plan_id`) REFERENCES `plans` (`id`) ON DELETE CASCADE,
  ...
  CONSTRAINT `accounts_industry_id_foreign` FOREIGN KEY (`industry_id`) REFERENCES `core__industries` (`id`),
  CONSTRAINT `accounts_invoice_design_id_foreign` FOREIGN KEY (`invoice_design_id`) REFERENCES `core__invoicedesigns` (`id`),
...
CREATE TABLE `timeline` (
  ...
  PRIMARY KEY (`id`),
  KEY `timeline_account_id_foreign` (`account_id`),
  KEY `timeline_user_id_index` (`user_id`),
  KEY `timeline_client_id_foreign` (`client_id`),
  KEY `timeline_payment_id_index` (`payment_id`),
  CONSTRAINT `timeline_account_id_foreign` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `timeline_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `clients` (
  ...
  CONSTRAINT `clients_industry_id_foreign` FOREIGN KEY (`industry_id`) REFERENCES `core__industries` (`id`),
...
INSERT INTO `gateways` VALUES (1,'2018-08-01 16:12:57','2018-08-01 16:12:57','Authorize.Net AIM','AuthorizeNet_AIM',1,1,5,0,NULL,0,0),(2,'2018-08-01 16:12:57','2018-08-01 16:12:57','Authorize.Net SIM','AuthorizeNet_SIM',1,2,10000,0,NULL,0,0),(3,'2018-08-01 16:12:57','2018-08-01 16:12:57','CardSave','CardSave',1,1,10000,0,NULL,0,0),(4,'2018-08-01 16:12:57','2018-08-01 16:12:57','Eway Rapid','Eway_RapidShared',1,1,10000,0,NULL,1,0),(5,'2018-08-01 16:12:57','2018-08-01 16:12:57','FirstData Connect','FirstData_Connect',1,1,10000,0,NULL,0,0),(6,'2018-08-01 16:12:57','2018-08-01 16:12:57','GoCardless','GoCardless',1,2,10000,0,NULL,1,0),(7,'2018-08-01 16:12:57','2018-08-01 16:12:57','Migs ThreeParty','Migs_ThreeParty',1,1,10000,0,NULL,0,0),(8,'2018-08-01 16:12:57','2018-08-01 16:12:57','Migs TwoParty','Migs_TwoParty',1,1,10000,0,NULL,0,0),(9,'2018-08-01 16:12:57','2018-08-01 16:12:57','Mollie','Mollie',1,1,8,0,NULL,1,0),(10,'2018-08-01 16:12:57','2018-08-01 16:12:57','MultiSafepay','MultiSafepay',1,1,10000,0,NULL,0,0),(11,'2018-08-01 16:12:57','2018-08-01 16:12:57','Netaxept','Netaxept',1,1,10000,0,NULL,0,0),(12,'2018-08-01 16:12:57','2018-08-01 16:12:57','NetBanx','NetBanx',1,1,10000,0,NULL,0,0),(13,'2018-08-01 16:12:57','2018-08-01 16:12:57','PayFast','PayFast',1,1,10000,0,NULL,1,0),(14,'2018-08-01 16:12:57','2018-08-01 16:12:57','Payflow Pro','Payflow_Pro',1,1,10000,0,NULL,0,0),(15,'2018-08-01 16:12:57','2018-08-01 16:12:57','PaymentExpress PxPay','PaymentExpress_PxPay',1,1,10000,0,NULL,0,0),(16,'2018-08-01 16:12:57','2018-08-01 16:12:57','PaymentExpress PxPost','PaymentExpress_PxPost',1,1,10000,0,NULL,0,0),(17,'2018-08-01 16:12:57','2018-08-01 16:12:57','PayPal Express','PayPal_Express',1,1,4,0,NULL,1,0),(18,'2018-08-01 16:12:57','2018-08-01 16:12:57','PayPal Pro','PayPal_Pro',1,1,10000,0,NULL,0,0),(19,'2018-08-01 16:12:57','2018-08-01 16:12:57','Pin','Pin',1,1,10000,0,NULL,0,0),(20,'2018-08-01 16:12:57','2018-08-01 16:12:57','SagePay Direct','SagePay_Direct',1,1,10000,0,NULL,0,0),(21,'2018-08-01 16:12:57','2018-08-01 16:12:57','SagePay Server','SagePay_Server',1,2,10000,0,NULL,1,0),(22,'2018-08-01 16:12:57','2018-08-01 16:12:57','SecurePay DirectPost','SecurePay_DirectPost',1,1,10000,0,NULL,0,0),(23,'2018-08-01 16:12:57','2018-08-01 16:12:57','Stripe','Stripe',1,1,1,0,NULL,0,0),(24,'2018-08-01 16:12:57','2018-08-01 16:12:57','TargetPay Direct eBanking','TargetPay_Directebanking',1,1,10000,0,NULL,0,0),(25,'2018-08-01 16:12:57','2018-08-01 16:12:57','TargetPay Ideal','TargetPay_Ideal',1,1,10000,0,NULL,0,0),(26,'2018-08-01 16:12:57','2018-08-01 16:12:57','TargetPay Mr Cash','TargetPay_Mrcash',1,1,10000,0,NULL,0,0),(27,'2018-08-01 16:12:57','2018-08-01 16:12:57','TwoCheckout','TwoCheckout',1,1,10000,0,NULL,1,0),(28,'2018-08-01 16:12:57','2018-08-01 16:12:57','WorldPay','WorldPay',1,1,10000,0,NULL,0,0),(29,'2018-08-01 16:12:57','2018-08-01 16:12:57','BeanStream','BeanStream',1,2,10000,0,NULL,0,0),(30,'2018-08-01 16:12:57','2018-08-01 16:12:57','Psigate','Psigate',1,2,10000,0,NULL,0,0),(31,'2018-08-01 16:12:57','2018-08-01 16:12:57','moolah','AuthorizeNet_AIM',1,1,10000,0,NULL,0,0),(32,'2018-08-01 16:12:57','2018-08-01 16:12:57','Alipay','Alipay_Express',1,1,10000,0,NULL,0,0),(33,'2018-08-01 16:12:57','2018-08-01 16:12:57','Buckaroo','Buckaroo_CreditCard',1,1,10000,0,NULL,0,0),(34,'2018-08-01 16:12:57','2018-08-01 16:12:57','Coinbase','Coinbase',1,1,10000,0,NULL,1,0),(35,'2018-08-01 16:12:57','2018-08-01 16:12:57','DataCash','DataCash',1,1,10000,0,NULL,0,0),(36,'2018-08-01 16:12:57','2018-08-01 16:12:57','Neteller','Neteller',1,2,10000,0,NULL,0,0),(37,'2018-08-01 16:12:57','2018-08-01 16:12:57','Pacnet','Pacnet',1,1,10000,0,NULL,0,0),(38,'2018-08-01 16:12:57','2018-08-01 16:12:57','PaymentSense','PaymentSense',1,2,10000,0,NULL,0,0),(39,'2018-08-01 16:12:57','2018-08-01 16:12:57','Realex','Realex_Remote',1,1,10000,0,NULL,0,0),(40,'2018-08-01 16:12:57','2018-08-01 16:12:57','Sisow','Sisow',1,1,10000,0,NULL,0,0),(41,'2018-08-01 16:12:57','2018-08-01 16:12:57','Skrill','Skrill',1,1,10000,0,NULL,1,0),(42,'2018-08-01 16:12:57','2018-08-01 16:12:57','BitPay','BitPay',1,1,7,0,NULL,1,0),(43,'2018-08-01 16:12:57','2018-08-01 16:12:57','Dwolla','Dwolla',1,2,6,0,NULL,1,0),(44,'2018-08-01 16:12:57','2018-08-01 16:12:57','AGMS','Agms',1,1,10000,0,NULL,0,0),(45,'2018-08-01 16:12:57','2018-08-01 16:12:57','Barclays','BarclaysEpdq\\Essential',1,1,10000,0,NULL,0,0),(46,'2018-08-01 16:12:57','2018-08-01 16:12:57','Cardgate','Cardgate',1,1,10000,0,NULL,0,0),(47,'2018-08-01 16:12:57','2018-08-01 16:12:57','Checkout.com','CheckoutCom',1,1,10000,0,NULL,0,0),(48,'2018-08-01 16:12:57','2018-08-01 16:12:57','Creditcall','Creditcall',1,1,10000,0,NULL,0,0),(49,'2018-08-01 16:12:57','2018-08-01 16:12:57','Cybersource','Cybersource',1,1,10000,0,NULL,0,0),(50,'2018-08-01 16:12:57','2018-08-01 16:12:57','ecoPayz','Ecopayz',1,1,10000,0,NULL,0,0),(51,'2018-08-01 16:12:57','2018-08-01 16:12:57','Fasapay','Fasapay',1,1,10000,0,NULL,0,0),(52,'2018-08-01 16:12:57','2018-08-01 16:12:57','Komoju','Komoju',1,1,10000,0,NULL,0,0),(53,'2018-08-01 16:12:57','2018-08-01 16:12:57','Multicards','Multicards',1,2,10000,0,NULL,0,0),(54,'2018-08-01 16:12:57','2018-08-01 16:12:57','Pagar.Me','Pagarme',1,2,10000,0,NULL,0,0),(55,'2018-08-01 16:12:57','2018-08-01 16:12:57','Paysafecard','Paysafecard',1,1,10000,0,NULL,0,0),(56,'2018-08-01 16:12:57','2018-08-01 16:12:57','Paytrace','Paytrace_CreditCard',1,1,10000,0,NULL,0,0),(57,'2018-08-01 16:12:57','2018-08-01 16:12:57','Secure Trading','SecureTrading',1,1,10000,0,NULL,0,0),(58,'2018-08-01 16:12:57','2018-08-01 16:12:57','SecPay','SecPay',1,1,10000,0,NULL,0,0),(59,'2018-08-01 16:12:57','2018-08-01 16:12:57','WeChat Express','WeChat_Express',1,2,10000,0,NULL,0,0),(60,'2018-08-01 16:12:57','2018-08-01 16:12:57','WePay','WePay',1,1,3,0,NULL,0,0),(61,'2018-08-01 16:12:57','2018-08-01 16:12:57','Braintree','Braintree',1,1,3,0,NULL,0,0),(62,'2018-08-01 16:12:57','2018-08-01 16:12:57','Custom','Custom1',1,1,20,0,NULL,1,0),(63,'2018-08-01 16:12:57','2018-08-01 16:12:57','FirstData Payeezy','FirstData_Payeezy',1,1,10000,0,NULL,0,0),(64,'2018-08-01 16:12:57','2018-08-01 16:12:57','GoCardless','GoCardlessV2\\Redirect',1,1,9,0,NULL,1,0),(65,'2018-08-01 16:12:57','2018-08-01 16:12:57','PagSeguro','PagSeguro',1,1,10000,0,NULL,0,0),(66,'2018-08-01 16:12:57','2018-08-01 16:12:57','PAYMILL','Paymill',1,1,10000,0,NULL,0,0),(67,'2018-08-01 16:12:57','2018-08-01 16:12:57','Custom','Custom2',1,1,21,0,NULL,1,0),(68,'2018-08-01 16:12:57','2018-08-01 16:12:57','Custom','Custom3',1,1,22,0,NULL,1,0);
/*!40000 ALTER TABLE `gateways` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `core__industries`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `core__industries` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `core__invoicedesigns`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `core__invoicedesigns` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `invoices` (
  ...
  CONSTRAINT `invoices_invoice_design_id_foreign` FOREIGN KEY (`invoice_design_id`) REFERENCES `core__invoicedesigns` (`id`),
...
CREATE TABLE `lookup_accounts` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `lookup_plan_id` int(10) unsigned NOT NULL,
  `account_key` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `subdomain` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_accounts_account_key_unique` (`account_key`),
  UNIQUE KEY `lookup_accounts_subdomain_unique` (`subdomain`),
  KEY `lookup_accounts_lookup_plan_id_index` (`lookup_plan_id`),
  CONSTRAINT `lookup_accounts_lookup_plan_id_foreign` FOREIGN KEY (`lookup_plan_id`) REFERENCES `lookup_companies` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lookup_companies` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_companies_db_server_id_plan_id_unique` (`db_server_id`,`plan_id`),
  KEY `lookup_companies_plan_id_index` (`plan_id`),
...
INSERT INTO `payment_libraries` VALUES (1,'2018-08-01 16:12:56','2018-08-01 16:12:56','Omnipay',1),(2,'2018-08-01 16:12:56','2018-08-01 16:12:56','PHP-Payments [Deprecated]',1);
...
INSERT INTO `payment_terms` VALUES (1,7,'Net 7','2018-08-01 16:12:56','2018-08-01 16:12:56',NULL,0,0,1),(2,10,'Net 10','2018-08-01 16:12:56','2018-08-01 16:12:56',NULL,0,0,2),(3,14,'Net 14','2018-08-01 16:12:56','2018-08-01 16:12:56',NULL,0,0,3),(4,15,'Net 15','2018-08-01 16:12:56','2018-08-01 16:12:56',NULL,0,0,4),(5,30,'Net 30','2018-08-01 16:12:56','2018-08-01 16:12:56',NULL,0,0,5),(6,60,'Net 60','2018-08-01 16:12:56','2018-08-01 16:12:56',NULL,0,0,6),(7,90,'Net 90','2018-08-01 16:12:56','2018-08-01 16:12:56',NULL,0,0,7),(8,-1,'Net 0','2018-08-01 16:12:59','2018-08-01 16:12:59',NULL,0,0,0);
...
-- Dump completed on 2018-08-01 22:13:00