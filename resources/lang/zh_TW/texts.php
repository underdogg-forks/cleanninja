...
客戶:client 已為 發票 :invoice支付 :amount。',
    ...
    'type' => '類型',
    'timeline_1' => ':user 建立 :client之客戶資料',
    'timeline_2' => ':user 將 :client之客戶資料存檔',
    'timeline_3' => ':user 已刪除客戶 :client',
    'timeline_4' => ':user 已建立 :client之客戶資料',
    'timeline_5' => ':user 已更新發票 :invoice',
    'timeline_6' => ':user 已寄送 :invoice 給 :contact',
    'timeline_7' => ':contact 已查看e :invoice',
    'timeline_8' => ':user 已將 :invoice存檔',
    'timeline_9' => ':user 已刪除發票 :invoice',
    'timeline_10' => ':contact 已輸入 :invoice的付款金額 :payment ',
    'timeline_11' => ':user 已更新付款資料 :payment',
    'timeline_12' => ':user 已儲存付款資料 :payment',
    'timeline_13' => ':user 已刪除付款資料 :payment',
    'timeline_14' => ':user 已輸入貸款資料 :credit ',
    'timeline_15' => ':user 更新貸款 :credit',
    'timeline_16' => ':user 已將 :credit 貸款資料存檔',
    'timeline_17' => ':user 已刪除 :credit 貸款資料',
    'timeline_18' => ':user 已建立發票:quote',
    'timeline_19' => ':user 已更新發票 :quote',
    'timeline_20' => ':user 以將報價單 :quote 以電子郵件寄給 :contact',
    'timeline_21' => ':contact 已閱覽報價單 :quote',
    'timeline_22' => ':user 已將發票 :quote存檔',
    'timeline_23' => ':user 已刪除發票 :quote',
    'timeline_24' => ':user 已復原報價單 :quote',
    'timeline_25' => ':user 已復原發票 :invoice',
    'timeline_26' => ':user已復原客戶 :client資料',
    'timeline_27' => ':user 已復原付款資料 :payment',
    'timeline_28' => ':user 已復原 :credit 貸款資料',
    'timeline_29' => ':contact 同意報價單 :quote',
    'timeline_30' => ':user已建立供應商 :vendor資料',
    'timeline_31' => ':user已將供應商 :vendor存檔',
    'timeline_32' => ':user已刪除供應商 :vendor',
    'timeline_33' => ':user已復原供應商 :vendor',
    'timeline_34' => ':user已建立支出 :expense',
    'timeline_35' => ':user已將支出 :expense存檔',
    'timeline_36' => ':user已刪除支出 :expense',
    'timeline_37' => ':user已復原支出 :expense',
    'timeline_42' => ':user 已建立任務 :task',
    'timeline_43' => ':user 已將任務 :task更新',
    'timeline_44' => ':user 已將任務 :task存檔',
    'timeline_45' => ':user 已將任務 :task刪除',
    'timeline_46' => ':user 已將任務 :task復原',
    'timeline_47' => ':user 已將支出 :expense更新',
    'payment' => '付款',
    'system' => '系統',
    'signature' => '電子郵件簽名',
    ...
    'timeline_39' => ':user 取消一項 :payment_amount 的付款 :payment',
    'timeline_40' => ':user 獲得一筆金額 :payment_amount 付款 :payment的退款 :adjustment',
...
一旦您收到這兩筆款項，請回到這個付款方式頁面，並點擊帳號旁邊的「完成驗證」。',
    ...
    'timeline_41' => ':payment_amount 的付款 (:payment) 失敗',
    ...
    'ach_authorization' => '我准許 :plan 以後使用我的銀行帳號來處理我的付款，而若有必要，以電子方是存款至我的帳戶以修正錯誤的扣款。我瞭解我隨時可以移除這項付款方式或藉由聯絡 :email來取消這項准許。',
    ...
    'plan_name' => '公司名稱',
    'wepay_plan_name_help' => '這將顯示於客戶的新用卡對帳單。',
...
<ul><li>以彈性的商營運方式進行貸款與發票結帳。</li></ul>',
    ...
    'delete_plan' => '刪除公司資料',
    'delete_plan_help' => '永久刪除此公司及相關的所有資料與設定',
    'delete_plan_message' => '警告：這將永久刪除您的公司資料，而且不可能復原。',
    ...
    'deleted_plan' => '已成功地清除公司資料',
    'deleted_account' => '已成功地取消帳號',
    'deleted_plan_details' => '已成功地刪除您的公司 (:account) 資料。',
...
',
    ...
    'iban' => '國際銀行帳戶號碼',
    'sepa_authorization' => '在提供您的國際銀行帳戶號碼並確認這項付款的同時，您准許 :plan 與我們的支付服務協力廠商 Stripe寄送指示給您的銀行，以配合指示從您的帳戶取款。在您與您的銀行約定的條款與條件之下，您有權利從您的銀行取得退款。任何退款須在您的銀行扣款成功後的8週內提出要求。',
