...
-- ส่งอีเมลมาที่ contact@invoiceninja.com',
    ...
    'plan_fields' => 'เขตข้อมูลของ บริษัท',
    ...
    'type' => 'ชนิด',
    'timeline_1' => ':user ได้สร้างผู้ใช้ :client',
    'timeline_2' => ':user เก็บบันทึก :client',
    'timeline_3' => ':user ได้ลบผู้ใช้ :client',
    'timeline_4' => ':user ได้สร้างใบแจ้งหนี้ :invoice',
    'timeline_5' => ':user ได้อัปเดทแจ้งหนี้ :invoice',
    'timeline_6' => ':user ได้ส่งใบแจ้งหนี้ :invoice ไปยัง :contact',
    'timeline_7' => ':contact ได้ดูใบแจ้งหนี้ :invoice',
    'timeline_8' => ':user บันทึกใบแจ้งหนี้ :invoice',
    'timeline_9' => ':user ได้ลบใบแจ้งหนี้ :invoice',
    'timeline_10' => ':contact  ป้อนการชำระเงิน :paymeny สำหรับ :invoice',
    'timeline_11' => ':user  อัปเดตการชำระเงินที่แล้ว :payment',
    'timeline_12' => ':user เก็บบันทึกการจ่ายเงิน  :payment',
    'timeline_13' => ':user ลบการจ่ายเงิน :payment',
    'timeline_14' => ':user ป้อน :credit เครดิต',
    'timeline_15' => ':user อัปเดต :credit เครดิต',
    'timeline_16' => ':user เก็บบันทึก :credit เครดิต',
    'timeline_17' => ':user ลบแล้ว :credit เครดิต',
    'timeline_18' => ':user สร้างใบเสนอราคา :quote',
    'timeline_19' => ';user อัปเดตใบเสนอราคา :quote',
    'timeline_20' => ':user อีเมล์ใบเสนอราคา :quote ไปยัง :contact',
    'timeline_21' => ':contact ดูใบเสนอราคา :quote',
    'timeline_22' => ':user เก็บบันทึกใบเสนอราคา :quote',
    'timeline_23' => ':user ลบใบเสนอราคา :quote',
    'timeline_24' => ':user กู้คืนใบเสนอราคา :quote',
    'timeline_25' => ':user กู้คืนใบแจ้งหนี้ :invoice',
    'timeline_26' => ':user กู้คืน ลูกค้า :client',
    'timeline_27' => ':user กู้คืนการชำระเงิน :payment',
    'timeline_28' => ':user กู้คืน :credit เครดิต',
    'timeline_29' => '.contact ใบเสนอราคาได้รับอนุมัติ :quote',
    'timeline_30' => ':user สร้างผู้ขาย :vendor',
    'timeline_31' => ':user เก็บบันทึกผู้ขาย :vendor',
    'timeline_32' => ':user ได้ลบผู้ขาย :vendor',
    'timeline_33' => ':user ได้กู้คืนผู้ขาย :vendor',
    'timeline_34' => ':user ได้สร้างค่าใช้จ่าย :expense',
    'timeline_35' => ':user ได้เก็บบันทึกค่าใช้จ่าย :expense',
    'timeline_36' => ':user ได้ลบค่าใช้จ่าย :expense',
    'timeline_37' => ':user ได้กู้คืนค่าใช้จ่าย :expense',
    'timeline_42' => ':user ได้สร้างงาน :task',
    'timeline_43' => ':user ได้อัปเดตงาน :task',
    'timeline_44' => ':user ได้บันทึกงาน :task',
    'timeline_45' => ':user ได้ลบงาน :task',
    'timeline_46' => ':user ได้กู้คืนงาน :task',
    'timeline_47' => ':user ได้อัปเดตค่าใช้จ่าย :expense',
    'payment' => 'การจ่ายเงิน',
    'system' => 'ระบบ',
...
<li>วันนี้เป็นวันศุกร์วันครบกำหนดคือวันศุกร์ที่ 1 หลังจาก วันครบกำหนดจะเป็นวันศุกร์ถัดไปไม่ใช่วันนี้
    ...
    'bankaccounts' => 'บัตรเครดิต & ธนาคาร',
...
แปลงใบเสนอราคาให้เป็นใบแจ้งหนี้โดยอัตโนมัติเมื่อได้รับอนุมัติจากลูกค้า',
    ...
    // Plans
    'plan_management' => 'การจัดการบัญชี',
    ...
    'timeline_39' => ':user ยกเลิก :payment_amount  การชำระเงิน :payment',
    'timeline_40' => ':usre คืนเงิน :adjustment ของ  :payment_amount การชำระเงิน :payment',
    ...
    'timeline_41' => ':payment_amount จ่ายชำระเงิน (:payment) ล้มเหลว',
    ...
    'ach_authorization' => 'ฉันอนุญาต :plan เพื่อใช้บัญชีธนาคารของฉันสำหรับการชำระเงินในอนาคตและหากจำเป็นให้เครดิตบัญชีของฉันทางอิเล็กทรอนิกส์เพื่อแก้ไขการตัดบัญชีที่ผิดพลาด. ฉันเข้าใจว่าฉันสามารถยกเลิกการให้สิทธิ์นี้เมื่อใดก็ได้โดยการลบวิธีการชำระเงินหรือโดยการติดต่อ :email',
    ...
    'plan_name' => 'ชื่อบริษัท',
    'wepay_plan_name_help' => 'ข้อความนี้จะปรากฏในใบแจ้งยอดบัตรเครดิตของลูกค้า',
...
<ul><li>สายธุรกิจที่ยืดหยุ่นของสินเชื่อและแฟ็กเรียลแฟกเตอริ่ง</li></ul>',
    ...
    'created_new_plan' => 'สร้างบริษัทใหม่เรียบร้อยแล้ว',
