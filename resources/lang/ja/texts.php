...
$LANG = array(
    ...
    'type' => 'Type',
    'timeline_1' => ':user は 顧客 :client を作成しました。',
    'timeline_2' => ':user は 顧客 :client をアーカイブしました。',
    'timeline_3' => ':user は 顧客 :client を削除しました。',
    'timeline_4' => ':user は 請求書 :invoice を作成しました。',
    'timeline_5' => ':user は 請求書 :invoice をアーカイブしました。',
    'timeline_6' => ':user は 請求書 :invoice を :contact にメールしました。',
    'timeline_7' => ':contact は 請求書 :invoice を閲覧しました。',
    'timeline_8' => ':user は 請求書 :invoice をアーカイブしました。',
    'timeline_9' => ':user は 請求書 :invoice をアーカイブしました。',
