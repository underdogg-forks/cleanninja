...
$LANG = array(
    ...
    'sign_up' => 'Најавување',
    'guest' => 'Гостин',
    'plan_details' => 'Детали за компанијата',
...
<li> "Задржано плаќање за :QUARTER+1" >> "Задржано плаќање за К2" </li>
 ...
 --пратете ни е-пошта на contact@invoiceninja.com',
    ...
    'plan_fields' => 'Полиња за компанијата',
    ...
    'add_plan' => 'Додај компанија',
    'untitled' => 'Без наслов',
    'new_plan' => 'Нова компанија',
 ...
 <p> Ако ви треба помош околу нешто објавете прашање на нашиот :forum_link со дизајнот кој го користите. </p>',
    ...
    'type' => 'Тип',
    'timeline_1' => ':user го креираше клиентот :client',
    'timeline_2' => ':user го архивираше клиентот :client',
    'timeline_3' => ':user го избриша клиентот :client',
    'timeline_4' => ':user ја креираше фактурата :invoice',
    'timeline_5' => ':user ја ажурираше фактурата :invoice',
    'timeline_6' => ':user ја испрати по е-пошта фактурата :invoice на :contact',
    'timeline_7' => ':contact ја прегледа фактурата :invoice',
    'timeline_8' => ':user ја архивира фактурата :invoice',
    'timeline_9' => ':user ја избриша фактурата :invoice',
    'timeline_10' => ':contact го внесе плаќањето :payment за :invoice',
    'timeline_11' => ':user го ажурира плаќањето :payment',
    'timeline_12' => ':user го архивира плаќањето :payment',
    'timeline_13' => ':user го избриша плаќањето :payment',
    'timeline_14' => ':user внесе :credit кредит',
    'timeline_15' => ':user ажурира :credit кредит',
    'timeline_16' => ':user архивира :credit кредит',
    'timeline_17' => ':user избриша :credit кредит',
    'timeline_18' => ':user ја креира понудата :quote',
    'timeline_19' => ':user ја ажурира понудата :quote',
    'timeline_20' => ':user ја прати понудата :quote по е-пошта на :contact',
    'timeline_21' => ':contact ја виде понудата :quote',
    'timeline_22' => ':user ја архивира понудата :quote',
    'timeline_23' => ':user ја избриша понудата :quote',
    'timeline_24' => ':user ја поврати понудата :quote',
    'timeline_25' => ':user ја поврати фактурата :invoice',
    'timeline_26' => ':user го поврати клиентот :client',
    'timeline_27' => ':user го поврати плаќањето :payment',
    'timeline_28' => ':user го поврати :credit кредитот',
    'timeline_29' => ':contact ја одобри понудата :quote',
    'timeline_30' => ':user го креира продавачот :vendor',
    'timeline_31' => ':user го архивира продавачот :vendor',
    'timeline_32' => ':user го избриша продавачот :vendor',
    'timeline_33' => ':user го поврати продавачот :vendor',
    'timeline_34' => ':user го креира трошокот :expense',
    'timeline_35' => ':user го архивира трошокот :expense',
    'timeline_36' => ':user го избриша трошокот :expense',
    'timeline_37' => ':user го поврати трошокот :expense',
    'timeline_42' => ':user ја креира задачата :task',
    'timeline_43' => ':user ажурира задачата :task',
    'timeline_44' => ':user ја архивира задачата :task',
    'timeline_45' => ':user ја избриша задачата :task',
    'timeline_46' => ':user ја поврати задачата :task',
    'timeline_47' => ':user го ажурира трошокот :expense',
    'payment' => 'Плаќање',
    'system' => 'Систем',
 ...
 <li> Денес е петок, датумот на достасување е првиот петок потоа. Датумот на достасување би бил наредниот петок, не денес. 
    ...
    'bankaccounts' => 'Кредитни картички и банки',
    ...
    // Plans
    'plan_management' => 'Менаџирање на сметка',
    ...
    'timeline_39' => ':user го откажа :payment_amount плаќањето :payment',
    'timeline_40' => ':user го рефундира :adjustment на :payment_amount плаќање :payment',
    ...
    'plan_account' => 'Сметка на компанија',
...
Откако ќе ги добиете износите, вратете се на оваа страница за начин на плаќање и кликнете "Заврши Верификација" до сметката.',
    ...
    'timeline_41' => ':payment_amount плаќање (:payment) е неуспешно',
    ...
    'ach_authorization' => 'Одобрувам :plan да ја користи мојата банкарска сметка за идни плаќања и, ако е потребно, електронски да ја кредитира мојата сметка за да ги поправи погрешните дебити. Разбирам дека можам да ја откажам оваа дозвола во било кое време со отстранување на начинот на плаќање или преку контактирање на :email.',
    ...
    'plan_name' => 'Име на компанија',
    'wepay_plan_name_help' => 'Ова ќе се појави на изјавите на кредитните картички од клиентите',
 ...
 <ul> <li> Флексибилни бизнис линии на кредит и факторинг на фактури </li> </ul> ',
    ...
    'created_new_plan' => 'Успешно креирана нова компанија',
    ...
    'billed' => 'Наплатено',
    'plan_variables' => 'Променливи на компанијата',
    ...
    'delete_plan' => 'Избриши компанија',
    'delete_plan_help' => 'Трајно избриши компанија заедно со сите податоци и поставки.',
    'delete_plan_message' => 'Предупредување: Ова трајно ќе ја избрише вашата компанија, нема враќање назад.',
    ...
    'deleted_plan' => 'Успешно избришана компанија',
    'deleted_account' => 'Успешно откажана сметка',
    'deleted_plan_details' => 'Вашата компанија (:account) е успешно избришана.',
