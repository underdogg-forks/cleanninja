...
$LANG = array(
    ...
    'guest' => 'Vieras',
    'plan_details' => 'Yrityksen yhteystiedot',
...
Lasku poistettiin (if only one, alternative)',
    ...
    'add_plan' => 'Lisää yritys',
    'untitled' => 'Nimetön',
    'new_plan' => 'Uusi yritys',
    ...
    'type' => 'Tyyppi',
    'timeline_1' => ':user loi asiakkaan :client',
    'timeline_2' => ':user arkistoi asiakkaan :client',
    'timeline_3' => ':user poisti asiakkaan :client',
    'timeline_4' => ':user loi laskun :invoice',
    'timeline_5' => ':user päivitti laskun :invoice',
    'timeline_6' => ':user lähetti laskun :invoice sähköpostilla asiakkaalle :contact',
    'timeline_7' => ':contact näki laskun :invoice',
    'timeline_8' => ':user arkistoi laskun :invoice',
    'timeline_9' => ':user poisti laskun :invoice',
    'timeline_10' => ':contact syötti maksun :payment laskulle :invoice',
    'timeline_11' => ':user päivitti maksun :payment',
    'timeline_12' => ':user arkistoi maksun :payment',
    'timeline_13' => ':user poisti maksun :payment',
    'timeline_14' => ':user syötti :credit hyvityksen',
    'timeline_15' => ':user päivitti :credit hyvityksen',
    'timeline_16' => ':user arkistoi :credit hyvityksen',
    'timeline_17' => ':user poisti :credit hyvityksen',
    'timeline_18' => ':user loi tarjouksen :quote',
    'timeline_19' => ':user päivitti tarjouksen :quote',
    'timeline_20' => ':user lähetti sähköpostilla tarjouksen :quote asiakkaalle :contact',
    'timeline_21' => ':contact luki tarjouksen :quote',
    'timeline_22' => ':user arkistoi tarjouksen :quote',
    'timeline_23' => ':user poisti tarjouksen :quote',
    'timeline_24' => ':user palautti tarjouksen :quote',
    'timeline_25' => ':user palautti laskun :invoice',
    'timeline_26' => ':user palautti asiakkaan :client',
    'timeline_27' => ':user palautti maksun :payment',
    'timeline_28' => ':user palautti hyvityksen :credit',
    'timeline_29' => ':contact hyväksyi tarjouksen :quote',
    'timeline_30' => ':user loi kauppiaan :vendor',
    'timeline_31' => ':user arkistoi kauppiaan :vendor',
    'timeline_32' => ':user poisti kauppiaan :vendor',
    'timeline_33' => ':user palautti kauppiaan :vendor',
    'timeline_34' => ':user loi kulun :expense',
    'timeline_35' => ':user arkistoi kulun :expense',
    'timeline_36' => ':user poisti kulun :expense',
    'timeline_37' => ':user palautti kulun :expense',
    'timeline_42' => ':user loi tehtävän :task',
    'timeline_43' => ':user päivitti tehtävän :task',
    'timeline_44' => ':user arkistoi tehtävän :task',
    'timeline_45' => ':user poisti tehtävän :task',
    'timeline_46' => ':user palautti tehtävän :task',
    'timeline_47' => ':user päivitti kulun :expense',
    'payment' => 'Maksu',
    'system' => 'Järjestelmä',
