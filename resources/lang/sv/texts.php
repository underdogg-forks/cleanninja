...
$LANG = array(
    ...
    'add_plan' => 'Lägg till företag',
    'untitled' => 'Obetitlad',
    'new_plan' => 'Nytt företag',
    ...
    'type' => 'Typ',
    'timeline_1' => ':user skapade kund :client',
    'timeline_2' => ':user arkiverade kund :client',
    'timeline_3' => ':user raderade kund :client',
    'timeline_4' => ':user skapade faktura :invoice',
    'timeline_5' => ':user uppdaterade faktura :invoice',
    'timeline_6' => ':user e-postade faktura :invoice till :contact',
    'timeline_7' => ':contact granskade faktura :invoice',
    'timeline_8' => ':user arkiverade faktura :invoice',
    'timeline_9' => ':user raderade faktura :invoice',
    'timeline_10' => ':contact  skickade betalning :payment för :invoice',
    'timeline_11' => ':user uppdaterade betalning :payment',
    'timeline_12' => ':user arkiverade betalning :payment',
    'timeline_13' => ':user tog bort betalning :payment',
    'timeline_14' => ':user skickade in :credit kredit',
    'timeline_15' => ':user updaterade :credit kredit',
    'timeline_16' => ':user arkiverade :credit kredit',
    'timeline_17' => ':user tog bort :credit kredit',
    'timeline_18' => ':user skapade offert :quote',
    'timeline_19' => ':user uppdaterade offert :quote',
    'timeline_20' => ':user e-postade offert :quote till :contact',
    'timeline_21' => ':contact visade offert :quote',
    'timeline_22' => ':user arkiverade offert :quote',
    'timeline_23' => ':user tog bort offert :quote',
    'timeline_24' => ':user återställde offert :quote',
    'timeline_25' => ':user återställde Faktura :invoice',
    'timeline_26' => ':user återställde klient :client',
    'timeline_27' => ':user återställde betalning :payment',
    'timeline_28' => ':user återställde :credit kredit',
    'timeline_29' => ':contact godkände offert :quote',
    'timeline_30' => ':user skapade leverantör :vendor',
    'timeline_31' => ':user arkiverade leverantör :vendor',
    'timeline_32' => ':user tog bort leverantör :vendor',
    'timeline_33' => ':user återställde leverantör :vendor',
    'timeline_34' => ':user skapade kostnad :expense',
    'timeline_35' => ':user arkiverade kostnad :expense',
    'timeline_36' => ':user tog bort kostnad :expense',
    'timeline_37' => ':user återställde kostnad :expense',
    'timeline_42' => ':user skapade uppgift :task',
    'timeline_43' => ':user uppdaterade uppgift :task',
    'timeline_44' => ':user arkiverade uppgift :task',
    'timeline_45' => ':user tog bort uppgift :task',
    'timeline_46' => ':user återställde uppgift :task',
    'timeline_47' => ':user uppdaterade kostnad :expense',
    'payment' => 'Betalning',
    'system' => 'System',
...
<p> Fakturor på en månadsvis eller årlig cykel, på eller före den dag de skapas kommer att bero på nästa månad. Fakturor som förfaller på den 29: e eller 30: e månader som inte har den dagen kommer att betalas den sista dagen i månaden. </ P>
 ...
 <li> Är idagg en fredag, är förfallodagen den 1: a fredag efter. Förfallodagen kommer att vara nästa fredag, inte idag.
    ...
    'bankaccounts' => 'Betalkort och Banker',
    ...
    // Plans
    'plan_management' => 'Konto hantering',
    ...
    'timeline_39' => ':user avbröt en :payment_amount betalning :payment',
    'timeline_40' => ':user återbetalade :adjustment av en :payment_amount betalning :payment',
...
När ni har pengarna, kom tillbaka till denna betalningsmetods sida och klicka på "Slutför verifikation" vid sidan om konto.',
    ...
    'timeline_41' => ':payment_amount betalning (:payment) misslyckad',
    ...
    'ach_authorization' => 'Jag godkänner :plan att använda mitt bankkonto för framtida betalningar och vid behov, elektroniskt kreditera mitt konto för att korrigera felaktiga debiteringar. Jag förstår att jag kan avbryta tillståndet när som helst genom att ta bort betalningsmetod eller genom att kontakta :email.',
    ...
    'plan_name' => 'Företagsnamn',
    'wepay_plan_name_help' => 'Detta uppges på klient kreditkortsutdrag.',
...
<br />Aktivera detta om din webbläsare automatiskt laddar hem PDF:erna.',
    ...
    'created_new_plan' => 'Framgångsrikt skapat nytt företag',
    ...
    'billed' => 'Fakturerad',
    'plan_variables' => 'Företagsvariabler',
    ...
    'delete_plan' => 'Ta bort företag',
    'delete_plan_help' => 'Ta permanent bort bolaget tillsammans med all data och inställningar.',
    'delete_plan_message' => 'Varning: Detta kommer permanent ta bort till bolag, det finns ingen återvändo.',
    ...
    'deleted_plan_details' => 'Ditt bolag (:account) har tagits bort utan problem',
