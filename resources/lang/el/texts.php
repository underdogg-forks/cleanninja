...
$LANG = array(
    ...
    'sign_up' => 'Εγγραφή',
    'guest' => 'Επισκέπτης',
    'plan_details' => 'Στοιχεία Εταιρείας',
...
να σας βοηθήσουμε. Στείλτε μας email στο contact@invoiceninja.com\',',
    ...
    'add_plan' => 'Προσθήκη Εταιρείας',
    'untitled' => 'Ανώνυμο',
    'new_plan' => 'Νέα Εταιρεία',
    ...
    'type' => 'Τύπος',
    'timeline_1' => 'Ο χρήστης :user δημιούργησε τον πελάτη :client',
    'timeline_2' => 'Ο χρήστης :user αρχειοθέτησε τον πελάτη :client',
    'timeline_3' => 'Ο χρήστης :user διέγραψε τον πελάτη :client',
    'timeline_4' => 'Ο χρήστης :user δημιούργησε το τιμολόγιο :invoice',
    'timeline_5' => 'Ο χρήστης :user ενημέρωσε το τιμολόγιο :invoice',
    'timeline_6' => 'Ο χρήστης :user το τιμολόγιο :Invoice στην επαφή :contact',
    'timeline_7' => 'Η επαφή :contact είδε το τιμολόγιο :invoice',
    'timeline_8' => 'Ο χρήστης :user αρχειοθέτησε το τιμολόγιο :invoice',
    'timeline_9' => 'Ο χρήστης :user διέγραψε το τιμολόγιο :invoice',
    'timeline_10' => 'Η επαφή :contact καταχώρησε την πληρωμή :payment για το :Invoice',
    'timeline_11' => 'Ο χρήστης :user ενημέρωσε την πληρωμή :payment',
    'timeline_12' => 'Ο χρήστης :user αρχειοθέτησε την πληρωμή :payment',
    'timeline_13' => 'Ο χρήστης :user διέγραψε την πληρωμή :payment',
    'timeline_14' => 'Ο χρήστης :user καταχώρησε την πίστωση :credit',
    'timeline_15' => 'Ο χρήστης :user ενημέρωσε την πίστωση :credit',
    'timeline_16' => 'Ο χρήστης :user αρχειοθέτησε την πίστωση :credit',
    'timeline_17' => 'Ο χρήστης :user διέγραψε την πίστωση :credit',
    'timeline_18' => 'Ο χρήστης :user δημιουργησε την προσφορά :quote',
    'timeline_19' => 'Ο χρήστης :user ενημέρωσε την προσφορά :quote',
    'timeline_20' => 'Ο χρήστης :user έστειλε με email την προσφορά :quote στην επαφή :contact',
    'timeline_21' => 'Η επαφή :contact είδε την προσφορά :quote',
    'timeline_22' => 'Ο χρήστης :user αρχειοθέτησε την προσφορά :quote',
    'timeline_23' => 'Ο χρήστης :user διέγραψε την προσφορά :quote',
    'timeline_24' => 'Ο χρήστης :user επανέφερε την προσφορά :quote',
    'timeline_25' => 'Ο χρήστης :user επανέφερε το τιμολόγιο :invoice',
    'timeline_26' => 'Ο χρήστης :user επανέφερε τον πελάτη :client',
    'timeline_27' => 'Ο χρήστης :user επανέφερε την πληρωμή :payment',
    'timeline_28' => 'Ο χρήστης :user επανέφερε την πίστωση :credit',
    'timeline_29' => 'Η επαφή :contact αποδέχτηκε την προσφορά :quote',
    'timeline_30' => 'Ο χρήστης :user δημιούργησε τον προμηθευτή :vendor',
    'timeline_31' => 'Ο χρήστης :user αρχειοθέτησε τον προμηθευτή :vendor',
    'timeline_32' => 'Ο χρήστης :user διέγραψε τον προμηθευτή :vendor',
    'timeline_33' => 'Ο χρήστης :user επανέφερε τον προμηθευτή :vendor',
    'timeline_34' => 'Ο χρήστης :user δημιούργησε τη δαπάνη :expense',
    'timeline_35' => 'Ο χρήστης :user αρχειοθέτησε τη δαπάνη :expense',
    'timeline_36' => 'Ο χρήστης :user διέγραψε τη δαπάνη :expense',
    'timeline_37' => 'Ο χρήστης :user επανέφερε τη δαπάνη :expense',
    'timeline_42' => 'Ο χρήστης :user δημιούργησε την εργασία :task',
    'timeline_43' => 'Ο χρήστης :user ενημέρωσε την εργασία :task',
    'timeline_44' => 'Ο χρήστης :user αρχειοθέτησε την εργασία :task',
    'timeline_45' => 'Ο χρήστης :user διέγραψε την εργασία :task',
    'timeline_46' => 'Ο χρήστης :user επανέφερε την εργασία :task',
    'timeline_47' => 'Ο χρήστης :user ενημέρωσε τη δαπάνη :expense',
    'payment' => 'Πληρωμή',
    'system' => 'Σύστημα',
    ...
    'bankaccounts' => 'Πιστωτικές Κάρτες & Τράπεζες',
    ...
    // Plans
    'plan_management' => 'Διαχείριση Λογαριασμού',
    ...
    'timeline_39' => ':user ακύρωσε :payment_amount πληρωμής :payment',
    'timeline_40' => ':user επέστρεψε :adjustment μιας :payment_amount πληρωμής :payment',
    ...
    'plan_account' => 'Εταιρικός Λογαριασμός',
    ...
    'timeline_41' => ':payment_amount πληρωμής (:payment) απέτυχε',
    ...
    'plan_name' => 'Όνομα Εταιρείας',
    'wepay_plan_name_help' => 'Αυτό θα εμφανιστεί στην ανάλυση λογαριασμού της πιστωτικής κάρτας του πελάτη.',
...
<ul><li>Ευέλικτες πιστωτικές λύσεις και factoring τιμολογίων.</li></ul>',
    ...
    'created_new_plan' => 'Επιτυχής δημιουργία νέας εταιρίας',
    ...
    'plan_variables' => 'Μεταβλητές Εταιρίας',
    ...
    'delete_plan' => 'Διαγραφή Επιχείρησης',
    'delete_plan_help' => 'Οριστική διαγραφή της επιχείρησης μαζί με όλα τα δεδομένα και τις ρυθμίσεις.',
    'delete_plan_message' => 'Προειδοποίηση: Αυτό θα διαγράψει οριστικά την επιχείρηση, χωρίς αναίρεση.',
    ...
    'deleted_plan' => 'Επιτυχής διαγραφή επιχείρησης',
    'deleted_account' => 'Επιτυχής ακύρωση λογαριασμού',
    'deleted_plan_details' => 'Η επιχείρησή σας (:account) έχει διαγραφεί επιτυχώς.',
