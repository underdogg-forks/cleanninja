...
if (! defined('APP_NAME')) {
    ...
    define('ENTITY_TIMELINE', 'timeline');
    define('ENTITY_VENDOR', 'vendor');
    define('ENTITY_VENDOR_TIMELINE', 'vendor_timeline');
    define('ENTITY_EXPENSE', 'expense');
    define('ENTITY_PAYMENT_TERM', 'payment_term');
    define('ENTITY_EXPENSE_TIMELINE', 'expense_timeline');
    ...
    define('TIMELINE_TYPE_CREATE_CLIENT', 1);
    define('TIMELINE_TYPE_ARCHIVE_CLIENT', 2);
    define('TIMELINE_TYPE_DELETE_CLIENT', 3);
    define('TIMELINE_TYPE_CREATE_INVOICE', 4);
    define('TIMELINE_TYPE_UPDATE_INVOICE', 5);
    define('TIMELINE_TYPE_EMAIL_INVOICE', 6);
    define('TIMELINE_TYPE_VIEW_INVOICE', 7);
    define('TIMELINE_TYPE_ARCHIVE_INVOICE', 8);
    define('TIMELINE_TYPE_DELETE_INVOICE', 9);
    define('TIMELINE_TYPE_CREATE_PAYMENT', 10);
    //define('TIMELINE_TYPE_UPDATE_PAYMENT', 11);
    define('TIMELINE_TYPE_ARCHIVE_PAYMENT', 12);
    define('TIMELINE_TYPE_DELETE_PAYMENT', 13);
    define('TIMELINE_TYPE_CREATE_CREDIT', 14);
    //define('TIMELINE_TYPE_UPDATE_CREDIT', 15);
    define('TIMELINE_TYPE_ARCHIVE_CREDIT', 16);
    define('TIMELINE_TYPE_DELETE_CREDIT', 17);
    define('TIMELINE_TYPE_CREATE_QUOTE', 18);
    define('TIMELINE_TYPE_UPDATE_QUOTE', 19);
    define('TIMELINE_TYPE_EMAIL_QUOTE', 20);
    define('TIMELINE_TYPE_VIEW_QUOTE', 21);
    define('TIMELINE_TYPE_ARCHIVE_QUOTE', 22);
    define('TIMELINE_TYPE_DELETE_QUOTE', 23);
    define('TIMELINE_TYPE_RESTORE_QUOTE', 24);
    define('TIMELINE_TYPE_RESTORE_INVOICE', 25);
    define('TIMELINE_TYPE_RESTORE_CLIENT', 26);
    define('TIMELINE_TYPE_RESTORE_PAYMENT', 27);
    define('TIMELINE_TYPE_RESTORE_CREDIT', 28);
    define('TIMELINE_TYPE_APPROVE_QUOTE', 29);
    define('TIMELINE_TYPE_CREATE_VENDOR', 30);
    define('TIMELINE_TYPE_ARCHIVE_VENDOR', 31);
    define('TIMELINE_TYPE_DELETE_VENDOR', 32);
    define('TIMELINE_TYPE_RESTORE_VENDOR', 33);
    define('TIMELINE_TYPE_CREATE_EXPENSE', 34);
    define('TIMELINE_TYPE_ARCHIVE_EXPENSE', 35);
    define('TIMELINE_TYPE_DELETE_EXPENSE', 36);
    define('TIMELINE_TYPE_RESTORE_EXPENSE', 37);
    define('TIMELINE_TYPE_VOIDED_PAYMENT', 39);
    define('TIMELINE_TYPE_REFUNDED_PAYMENT', 40);
    define('TIMELINE_TYPE_FAILED_PAYMENT', 41);
    define('TIMELINE_TYPE_CREATE_TASK', 42);
    define('TIMELINE_TYPE_UPDATE_TASK', 43);
    define('TIMELINE_TYPE_ARCHIVE_TASK', 44);
    define('TIMELINE_TYPE_DELETE_TASK', 45);
    define('TIMELINE_TYPE_RESTORE_TASK', 46);
    define('TIMELINE_TYPE_UPDATE_EXPENSE', 47);
    define('TIMELINE_TYPE_USER_UPDATE_TICKET', 48);
    define('TIMELINE_TYPE_USER_CLOSE_TICKET', 49);
    define('TIMELINE_TYPE_USER_MERGE_TICKET', 50);
    define('TIMELINE_TYPE_USER_SPLIT_TICKET', 51);
    define('TIMELINE_TYPE_CONTACT_OPEN_TICKET', 52);
    define('TIMELINE_TYPE_CONTACT_REOPEN_TICKET', 53);
    define('TIMELINE_TYPE_USER_REOPEN_TICKET', 54);
    define('TIMELINE_TYPE_CONTACT_REPLY_TICKET', 55);
    define('TIMELINE_TYPE_USER_VIEW_TICKET', 56);
